...
static void LINFLEXD_SetUartWordLength(volatile struct linflexd *base, linflexd_uart_word_length_t length)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetTxDataFieldLength(volatile struct linflexd *base, uint8_t length)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetRxDataFieldLength(volatile struct linflexd *base, uint8_t length)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetParityControl(volatile struct linflexd *base, bool enable)
{
    uint32_t regValTemp;
...
static uint8_t LINFLEXD_GetRxDataBuffer1Byte(volatile struct linflexd * base)
{
    return (uint8_t)(base->BDRM & LINFlexD_BDRM_DATA4_MASK);
}

static void LINFLEXD_SetTxMode(volatile struct linflexd *base, linflexd_uart_rxtx_mode_t mode)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetRxMode(volatile struct linflexd *base, linflexd_uart_rxtx_mode_t mode)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetRxEnable(volatile struct linflexd *base, uint32_t enable)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetInterruptMode(volatile struct linflexd * base, uint32_t intSrc, bool enable)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetTransmitterState(volatile struct linflexd *base, bool enable)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetTxDataBuffer1Byte(volatile struct linflexd * base, int8_t data)
{
    uint32_t regValTemp;
...
static inline uint8_t LINFLEXD_GetLinState(volatile struct linflexd * base)
{
    uint8_t state = (uint8_t)((base->LINSR & LINFlexD_LINSR_LINS_MASK) >> LINFlexD_LINSR_LINS_SHIFT);
    return state;
}

static void LINFLEXD_UART_DRV_SendData(volatile struct linflexd* instance, const int8_t* txBuff)
{    
...
static inline void LINFLEXD_EnterInitMode(volatile struct linflexd *base)
{
    uint32_t regValTemp;
...
static inline void LINFLEXD_EnterNormalMode(volatile struct linflexd *base)
{
    uint32_t regValTemp;
    regValTemp = base->LINCR1;
    regValTemp &= ~(LINFlexD_LINCR1_SLEEP_MASK);
...
static inline void LINFLEXD_SetIntegerBaudRate(volatile struct linflexd *base, uint32_t ibr)
{
    uint32_t regValTemp;
...
static inline void LINFLEXD_SetMode(volatile struct linflexd *base, linflexd_mode_t mode)
{
    uint32_t regValTemp;
    regValTemp = base->UARTCR;
...
// static void clock_init(volatile struct linflexd * base){
...
static void LINFLEXD_UART_DRV_SetBaudRate(volatile struct linflexd * base, uint32_t baudrate)
{
    uint32_t mantissa;
...
void linflexd_init(volatile struct linflexd * ptr_uart)
{
    ...
    // LINFLEXD_SetInterruptMode(ptr_uart, LINFlexD_FRAME_ERROR_INT, true);
    // LINFLEXD_SetInterruptMode(ptr_uart, LINFlexD_BUFFER_OVERRUN_INT, true);
}
...
uint32_t linflexd_getc(volatile struct linflexd * ptr_uart)
{
    ...
    // while(!(*base & 0x200));
    // data = LINFLEXD_GetRxDataBuffer1Byte((struct linflexd *)ptr_uart);
    // return data;
