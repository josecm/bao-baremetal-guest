...
#define LINFlexD_BASE_ADDRS   { LINFlexD_0_BASE, LINFlexD_1_BASE, LINFlexD_2_BASE, LINFlexD_3_BASE, LINFlexD_4_BASE, LINFlexD_5_BASE, \
                            LINFlexD_6_BASE , LINFlexD_7_BASE, LINFlexD_8_BASE, LINFlexD_9_BASE, LINFlexD_10_BASE, \
                            LINFlexD_11_BASE }
/** Array initializer of LINFLEXD peripheral base pointers */
#define LINFlexD_BASE_PTRS    { LINFlexD_0, LINFlexD_1, LINFlexD_2, LINFlexD_3, LINFlexD_4, LINFlexD_5, LINFlexD_6, \
                                LINFlexD_7, LINFlexD_8, LINFlexD_9, LINFlexD_10, LINFlexD_11}

/* Table of base addresses for LINFlexD instances. */
static struct linflexd * const s_LINFlexDBase[LINFlexD_INSTANCE_COUNT] = LINFlexD_BASE_PTRS;
...
typedef enum
{
    HALF_STRENGTH_WITH_SLEWRATE_CONTROL    = 0u, /*!< Half Strength with Slewrate Control, apply for SIUL2_AE        */
    FULL_STRENGTH_WITH_SLEWRATE_CONTROL    = 1u, /*!< Full Strength with Slewrate Control, apply for SIUL2_AE        */
    HALF_STRENGTH_WITHOUT_SLEWRATE_CONTROL = 2u, /*!< Half Strength without Slewrate Control, apply for SIUL2_AE     */
    FULL_STRENGTH_WITHOUT_SLEWRATE_CONTROL = 3u, /*!< Full Strength without Slewrate Control, apply for SIUL2_AE     */
...
#define SIUL2_1_MSCR_OBE(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_OBE_SHIFT)) & SIUL2_1_MSCR_OBE_MASK)
#define SIUL2_1_MSCR_ODE_MASK                    (0x100000U)
#define SIUL2_1_MSCR_ODE_SHIFT                   (20U)
#define SIUL2_1_MSCR_ODE_WIDTH                   (1U)
#define SIUL2_1_MSCR_ODE(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_ODE_SHIFT)) & SIUL2_1_MSCR_ODE_MASK)
#define SIUL2_1_MSCR_SRE_MASK                    (0x1C000U)
#define SIUL2_1_MSCR_SRE_SHIFT                   (14U)
#define SIUL2_1_MSCR_SRE_WIDTH                   (3U)
#define SIUL2_1_MSCR_SRE(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_SRE_SHIFT)) & SIUL2_1_MSCR_SRE_MASK)
#define SIUL2_1_MSCR_IBE_MASK                    (0x80000U)
#define SIUL2_1_MSCR_IBE_SHIFT                   (19U)
#define SIUL2_1_MSCR_IBE_WIDTH                   (1U)
#define SIUL2_1_MSCR_IBE(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_IBE_SHIFT)) & SIUL2_1_MSCR_IBE_MASK)
#define SIUL2_1_MSCR_SSS_MASK                    (0x7U)
#define SIUL2_1_MSCR_SSS_SHIFT                   (0U)
#define SIUL2_1_MSCR_SSS_WIDTH                   (3U)
#define SIUL2_1_MSCR_SSS(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_SSS_SHIFT)) & SIUL2_1_MSCR_SSS_MASK)
#define SIUL2_1_MSCR_SMC_MASK                    (0x20U)
#define SIUL2_1_MSCR_SMC_SHIFT                   (5U)
#define SIUL2_1_MSCR_SMC_WIDTH                   (1U)
#define SIUL2_1_MSCR_SMC(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_SMC_SHIFT)) & SIUL2_1_MSCR_SMC_MASK)
#define SIUL2_1_MSCR_RCVR_MASK                   (0x400U)
#define SIUL2_1_MSCR_RCVR_SHIFT                  (10U)
#define SIUL2_1_MSCR_RCVR_WIDTH                  (1U)
#define SIUL2_1_MSCR_RCVR(x)                     (((uint32_t)(((uint32_t)(x)) << SIUL2_1_MSCR_RCVR_SHIFT)) & SIUL2_1_MSCR_RCVR_MASK)
#define SIUL2_AE_IMCR_SSS_MASK                   (0x7U)
#define SIUL2_AE_IMCR_SSS_SHIFT                  (0U)
#define SIUL2_AE_IMCR_SSS_WIDTH                  (3U)
#define SIUL2_AE_IMCR_SSS(x)                     (((uint32_t)(((uint32_t)(x)) << SIUL2_AE_IMCR_SSS_SHIFT)) & SIUL2_AE_IMCR_SSS_MASK)


/** GPIO - Register Layout Typedef */
typedef struct {
    uint16_t PGPDO;          /**< SIUL2 Parallel GPIO Pad Data Out Register, array offset: 0x1700, array step: 0x2 */
    uint16_t RESERVED_1[SIUL2_PGPDO_COUNT - 1U];
    uint16_t PGPDI;          /**< SIUL2 Parallel GPIO Pad Data In Register, array offset: 0x1740, array step: 0x2 */
} GPIO_Type;
...
typedef struct {
  ...
  uint8_t RESERVED_7[4];
    uint32_t IFMCR[SIUL2_IFMCR_COUNT];          /**< SIUL2 Interrupt Filter Maximum Counter Register, array offset: 0x40, array step: 0x4 */
  ...
  uint8_t RESERVED_9[380];
    uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration Register, array offset: 0x240, array step: 0x4 */
                                                   /**< SIUL2_0: MSCR102-505 are reserved */
                                                   /**< SIUL2_1: MSCR0-112/117-120/123-143/145/158-159/178/185-191/207/212-239/252/256-499 are reserved */
                                                   /**< SIUL2_AE: MSCR4-7/44-255/324-505 are reserved */
  uint8_t RESERVED_10[24];
    uint32_t IMCR[SIUL2_IMCR_COUNT];            /**< SIUL2 Input Multiplexed Signal Configuration Register, array offset: 0xAC0, array step: 0x4 */
                                                   /**< SIUL2_0: IMCR2/60-67/84-495 are reserved */
                                                   /**< SIUL2_1: IMCR0-57/65-68/76-119/127-129/135-136/148/155/169-172/174/177/179-189/200-205/215/217/219/
                                                        221/236-237/239-250/262/264/266/268/290/292/327-397/402-405/410-413/418-421/426-487 are reserved */
                                                   /**< SIUL2_AE: IMCR59-255/288-495 are reserved */
  uint8_t RESERVED_11[256];
   uint8_t GPDO[SIUL2_GPDO_COUNT];             /**< SIUL2 GPIO Pad Data Output Register, array offset: 0x1300, array step: 0x1 */
                                                   /**< SIUL2_0: GPDO100-101/104-511 are reserved */
                                                   /**< SIUL2_1: GPDO0-112/117-120/123-143/145/158-159/178/185-191/207/212-239/252/256-499 are reserved */
                                                   /**< SIUL2_AE: GPDO4-7/44-255/324-505 are reserved */
    uint8_t GPDI[SIUL2_GPDI_COUNT];             /**< SIUL2 GPIO Pad Data Input Register, array offset: 0x1500, array step: 0x1 */
                                                   /**< SIUL2_0: GPDI100-101/104-511 are reserved */
                                                   /**< SIUL2_1: GPDI0-112/117-120/123-143/145/158-159/178/185-191/207/212-239/252/256-499 are reserved */
                                                   /**< SIUL2_AE: GPDI4-7/44-255/324-505 are reserved */
    uint16_t PGPDO[SIUL2_PGPDO_COUNT];          /**< SIUL2 Parallel GPIO Pad Data Out Register, array offset: 0x1700, array step: 0x2 */
                                                   /**< SIUL2_0: PGPDO6/8-31 are reserved */
                                                   /**< SIUL2_1: PGPDO0-5/7/9/15-16/18-30 are reserved */
                                                   /**< SIUL2_AE: PGPDO2/4-31 are reserved */
    uint16_t PGPDI[SIUL2_PGPDI_COUNT];          /**< SIUL2 Parallel GPIO Pad Data In Register, array offset: 0x1740, array step: 0x2 */
                                                   /**< SIUL2_0: PGPDI6/8-31 are reserved */
                                                   /**< SIUL2_1: PGPDI0-5/7/9/15-16/18-30 are reserved */
                                                   /**< SIUL2_AE: PGPDI2/4-31 are reserved */
    uint32_t MPGPDO[SIUL2_MPGPDO_COUNT];         /**< SIUL2 Masked Parallel GPIO Pad Data Out Register, array offset: 0x1780, array step: 0x4 */
...
typedef struct
{
    ...
    //port_hysteresis_t           hysteresisSelect;  /*!< Configures the Hysteresis Enable, apply for SIUL2_1/AE     */
...
void linflexd_init(volatile struct linflexd * ptr_uart);
uint32_t linflexd_getc(volatile struct linflexd * ptr_uart);
void linflexd_putc(volatile struct linflexd * ptr_uart, int8_t c);
void linflexd_enable_rxirq(volatile struct linflexd * ptr_uart);
void linflexd_clear_rxirq(volatile struct linflexd * ptr_uart);
