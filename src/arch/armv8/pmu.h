...
static inline void pmu_counter_enable(size_t counter, bool en){
...
static inline void pmu_counter_get(size_t counter, unsigned long value){
    MSR(PMSELR_EL0, counter);
    //barrier?
    MRS(PMXEVCNTR_EL0, value);
}
